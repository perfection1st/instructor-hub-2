...
export const WeeklyModal = (props) => {
  ...
  return (
    <>
      ...
      >
        <BsCalendarPlusFill /> Add Weekly Update{" "}
      </button>

      {/* Weekly modal */}
      <Modal
        id="weekly-update-modal"
        size="md"
        centered
        show={showWeeklyModal}
        onHide={handleCloseWeeklyModal}
      >
      ...
      <Modal
        id="weekly-grading-modal"
        size="md"
        centered
        show={showWeeklyGradingModal}
        onHide={handleCloseWeeklyGradingModal}
      >
        <Modal.Header closeButton>
